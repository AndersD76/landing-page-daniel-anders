const translations = {
  en: {
    ...
    test_1_p: "Delivered the project ahead of schedule and with quality above expectations. Understands business, not just code. We're already on our third project together.",
    test_1_name: "Rafael M.",
    test_1_role: "CEO, Manufacturing Industry",
    test_2_p: "The IoT system he built saved thousands in raw material losses. 24/7 monitoring with instant alerts. Exactly what we needed.",
    test_2_name: "Carlos S.",
    test_2_role: "Operations Manager, Logistics",
    test_3_p: "Flawless communication. Every week there was a working demo. I've never worked with a dev who understood so well what I needed from a business perspective.",
    test_3_name: "Ana L.",
    test_3_role: "Founder, SaaS Startup",
  ...
  pt: {
    ...
    cases_sub: "Projetos entregues com impacto mensuravel. Codigo em producao, nao em PowerPoint.",
    case_1_h: "Site Institucional — Industria",
    case_1_p: "Plataforma web completa para industria metalurgica. CMS integrado, SEO otimizado, formularios inteligentes, deploy automatizado.",
    case_1_m1: "mais leads organicos",
    case_1_m2: "tempo de carregamento",
    case_1_m3: "ate producao",
    ...
    case_2_m1: "monitoramento continuo",
    case_2_m2: "latencia do alerta",
    case_2_m3: "uptime",
    case_3_h: "Distribuicao de Conteudo Multi-Marca",
    case_3_p: "Sistema automatizado de distribuicao de conteudo para 5 marcas. Painel admin, agendamento, integracao Telegram, analytics por marca.",
    ...
    test_1_p: "Entregou o projeto antes do prazo e com qualidade acima do esperado. Entende de negocio, nao so de codigo. Ja estamos no terceiro projeto juntos.",
    test_1_name: "Rafael M.",
    test_1_role: "CEO, Industria Metalurgica",
    test_2_p: "O sistema IoT que ele construiu salvou milhares em perdas de materia-prima. Monitoramento 24/7 com alertas instantaneos. Exatamente o que precisavamos.",
    test_2_name: "Carlos S.",
    test_2_role: "Gerente de Operacoes, Logistica",
    test_3_p: "Comunicacao impecavel. Toda semana tinha demo funcionando. Nunca trabalhei com um dev que entendesse tao bem o que eu precisava do ponto de vista comercial.",
    test_3_name: "Ana L.",
    test_3_role: "Fundadora, Startup SaaS",
