            ...
            {apps.map((app) => (
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block text-center text-sm font-bold text-white bg-brand/90 hover:bg-brand px-6 py-3 rounded-full no-underline transition-all hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(230,57,70,0.3)]"
                >
                  QUERO ESSE APP
                </a>
              </div>
