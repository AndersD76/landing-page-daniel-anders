      ...
      <div className="container-main">
        <div className="flex flex-col md:flex-row items-start justify-between gap-8 mb-8">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">{t("footer_tagline")}</p>
          </div>
          <nav className="flex flex-wrap gap-x-8 gap-y-2">
            {[
              ...
              <Link
                key={link.href}
                href={link.href}
                className="text-xs font-semibold text-gray-600 no-underline tracking-[2px] uppercase hover:text-brand transition-colors"
              >
                {link.label}
              </Link>
            ))}
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-6 border-t border-white/[0.04]">
          ...
          <p className="text-xs text-gray-700">&copy; 2026 Daniel Anders</p>
        </div>
      </div>
    </footer>
  );
